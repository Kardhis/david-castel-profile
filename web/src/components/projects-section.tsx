  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[88rem] px-4 sm:px-6">
        ...
        <p className="mt-3 w-full text-pretty text-xl leading-loose text-zinc-400 md:text-2xl">{t("subtitle")}</p>
        <div className="mt-12 grid gap-6 md:grid-cols-2">
          <article className="group rounded-2xl border border-white/10 bg-gradient-to-br from-zinc-900 to-zinc-950 p-8 transition hover:border-sky-500/40">
            ...
            <h3 className="font-heading mt-3 text-xl font-semibold text-white md:text-2xl">
              {t("card1.title")}
            </h3>
